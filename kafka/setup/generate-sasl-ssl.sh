...
sasl.jaas.config=org.apache.kafka.common.security.plain.PlainLoginModule required username="client" password="$PASSWORD";
...
EOF
cd ..
cp ./$KEYSTORE_WORKING_DIRECTORY/* ./$SECRETS_FOLDER
cp ./$TRUSTSTORE_WORKING_DIRECTORY/* ./$SECRETS_FOLDER